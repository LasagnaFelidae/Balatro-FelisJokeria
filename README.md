...
![Felis Jokeria Logo](https://i.imgur.com/qPvCFnR.png)
...
- Totem System (NEW)
  ...
  - Totems grant their sigils on cards only when a Head is added to it, and will apply only to the tribe the head is associated to!
  - The Totems Card Area has a 5 card limit
  - Totem Vouchers:
  	- Totem Merchant (Voucher, enables totems in pool)
  	- Totem Tycoon (Voucher, enables 2x totem chance in shop)
...
- 4 Sigils (Different from Totem Sigils)
  ...
  - For them to be applied, you need to loot them in a booster or shop.
- 1 Deck and Sleeve
  - Totem Deck, enables Totems + redeems Totem Merchant
    - If Totem Sleeve is applied on Totem Deck, +1 Totem Area Size and redeems Totem Tycoon
    - If Totem Sleeve is applied on Printer Deck (Revo's Vault), get a free Printer Tribe Totem Head
- 4 Tags
- 1 Visual Sticker
  - Stitched, when merging two cards together with The Mycologists
- 1 Temporary Sticker
  - Copied, Destroys joker at the end of the round, sets sell value to $1
